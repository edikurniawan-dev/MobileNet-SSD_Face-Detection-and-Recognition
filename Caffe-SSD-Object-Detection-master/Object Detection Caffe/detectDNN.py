...
ap.add_argument("-p", "--prototxt", default= 'Caffe/MobileNetSSD_deploy.prototxt', help = 'Path to prototxt')
ap.add_argument("-m", "--model", default= 'Caffe/MobileNetSSD_deploy.caffemodel', help = 'Path to model weights')
